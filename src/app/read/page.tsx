...
const LESSONS = [
  {id:1, suras:'Al-Fātiḥa', range:'Al-Istiʿādha · Q. 1:1–2:5', hasText:true},
  ...
  {id:7, suras:'Al-Baqara', range:'Q. 2:253–3:14', hasText:true},
  {id:8, suras:'Āl ʿImrān', range:'Q. 3:15–91', hasText:true},
  {id:9, suras:'Āl ʿImrān', range:'Q. 3:92–175', hasText:true},
  {id:10, suras:'Āl ʿImrān', range:'Q. 3:176–4:23', hasText:true},
  ...
  {id:20, suras:'Al-Aʿrāf', range:'Q. 7:171–8:40', hasText:true},
  {id:21, suras:'Al-Anfāl', range:'Q. 8:41–9:33', hasText:true},
  {id:22, suras:'Al-Tawba', range:'Q. 9:34–92', hasText:true},
  {id:23, suras:'Al-Tawba', range:'Q. 9:93–10:25', hasText:true},
  {id:24, suras:'Yūnus', range:'Q. 10:26–11:5', hasText:true},
  {id:25, suras:'Hūd', range:'Q. 11:6–83', hasText:true},
  {id:26, suras:'Hūd/Yūsuf', range:'Q. 11:84–12:52', hasText:true},
  {id:27, suras:'Yūsuf', range:'Q. 12:53–13:18', hasText:true},
  {id:28, suras:'Al-Raʿd', range:'Q. 13:19–14:52', hasText:true},
  {id:29, suras:'Al-Ḥijr', range:'Q. 15:1–16:89', hasText:true},
  {id:30, suras:'Al-Naḥl', range:'Q. 16:90–17:111', hasText:true},
  {id:31, suras:'Al-Kahf', range:'Sūrat Al-Kahf', hasText:true},
  {id:32, suras:'Maryam / Ṭāhā', range:'Sūrat Maryam – Sūrat Ṭāhā', hasText:true},
  {id:33, suras:'Ṭāhā / Al-Anbiyāʾ', range:'Sūrat Ṭāhā – Sūrat Al-Anbiyāʾ', hasText:true},
  {id:34, suras:'Al-Anbiyāʾ / Al-Ḥajj', range:'Sūrat Al-Anbiyāʾ – Sūrat Al-Ḥajj', hasText:true},
  {id:35, suras:'Al-Muʾminūn / Al-Nūr', range:'Sūrat Al-Muʾminūn – Sūrat Al-Nūr', hasText:true},
  {id:36, suras:'Al-Nūr / Al-Furqān', range:'Sūrat Al-Nūr – Sūrat Al-Furqān', hasText:true},
  {id:37, suras:'Al-Shuʿarāʾ / Al-Naml', range:'Sūrat Al-Shuʿarāʾ – Sūrat Al-Naml', hasText:true},
  {id:38, suras:'Al-Naml / Al-Qaṣaṣ', range:'Sūrat Al-Naml – Sūrat Al-Qaṣaṣ', hasText:true},
  {id:39, suras:'Al-ʿAnkabūt / Al-Rūm / Luqmān', range:'Sūrat Al-ʿAnkabūt – Sūrat Luqmān', hasText:true},
  {id:40, suras:'Luqmān / Al-Sajda / Al-Aḥzāb', range:'Sūrat Luqmān – Sūrat Al-Aḥzāb', hasText:true},
  {id:41, suras:'Al-Aḥzāb / Sabaʾ / Fāṭir', range:'Sūrat Al-Aḥzāb – Sūrat Fāṭir', hasText:true},
  {id:42, suras:'Fāṭir / Yā-Sīn / Al-Ṣāffāt', range:'Sūrat Fāṭir – Sūrat Al-Ṣāffāt', hasText:true},
  {id:43, suras:'Al-Ṣāffāt / Ṣād / Al-Zumar', range:'Sūrat Al-Ṣāffāt – Sūrat Al-Zumar', hasText:true},
  {id:44, suras:'Ghāfir / Fuṣṣilat', range:'Sūrat Ghāfir – Sūrat Fuṣṣilat', hasText:true},
  {id:45, suras:'Fuṣṣilat / Al-Shūrā / Al-Zukhruf / Al-Dukhān', range:'Sūrat Fuṣṣilat – Sūrat Al-Dukhān', hasText:true},
  {id:46, suras:'Al-Dukhān / Al-Jāthiya / Al-Aḥqāf / Muḥammad / Al-Fatḥ', range:'Sūrat Al-Dukhān – Sūrat Al-Fatḥ', hasText:true},
  {id:47, suras:'Al-Fatḥ / Al-Ḥujurāt / Qāf / Al-Dhāriyāt', range:'Sūrat Al-Fatḥ – Sūrat Al-Dhāriyāt', hasText:true},
  {id:48, suras:'Al-Dhāriyāt / Al-Ṭūr / Al-Najm / Al-Qamar', range:'Sūrat Al-Dhāriyāt – Sūrat Al-Qamar', hasText:true},
  {id:49, suras:'Al-Raḥmān / Al-Wāqiʿa / Al-Ḥadīd', range:'Sūrat Al-Raḥmān – Sūrat Al-Ḥadīd', hasText:true},
  {id:50, suras:'Al-Mujādala / Al-Ḥashr / Al-Mumtaḥana / Al-Ṣaff', range:'Sūrat Al-Mujādala – Sūrat Al-Ṣaff', hasText:true},
  {id:51, suras:'Al-Jumuʿa / Al-Munāfiqūn / Al-Taghābun / Al-Ṭalāq / Al-Taḥrīm', range:'Sūrat Al-Jumuʿa – Sūrat Al-Taḥrīm', hasText:true},
  {id:52, suras:'Al-Mulk / Al-Qalam / Al-Ḥāqqa / Al-Maʿārij / Nūḥ', range:'Sūrat Al-Mulk – Sūrat Nūḥ', hasText:true},
  {id:53, suras:'Al-Jinn / Al-Muzzammil / Al-Muddaththir / Al-Qiyāma / Al-Insān / Al-Mursalāt', range:'Sūrat Al-Jinn – Sūrat Al-Mursalāt', hasText:true},
  {id:54, suras:'Al-Nabaʾ / Al-Nāziʿāt / ʿAbasa / Al-Takwīr / Al-Infiṭār / Al-Muṭaffifīn / Al-Inshiqāq / Al-Burūj / Al-Ṭāriq', range:'Sūrat Al-Nabaʾ – Sūrat Al-Ṭāriq', hasText:true},
  {id:55, suras:'Al-Aʿlā / Al-Ghāshiya / Al-Fajr / Al-Balad / Al-Shams / Al-Layl / Al-Ḍuḥā / Al-Sharḥ / Al-Tīn / Al-ʿAlaq / Al-Qadr / Al-Bayyina / Al-Zalzala / Al-ʿĀdiyāt / Al-Qāriʿa / Al-Takāthur / Al-ʿAṣr / Al-Humaza / Al-Fīl / Quraysh / Al-Māʿūn / Al-Kawthar / Al-Kāfirūn / Al-Naṣr / Al-Masad', range:'Sūrat Al-Aʿlā – Sūrat Al-Masad', hasText:true},
  {id:56, suras:'Al-Ikhlāṣ / Al-Falaq / Al-Nās', range:'Sūrat Al-Ikhlāṣ – Sūrat Al-Nās', hasText:true},
];
    ...
    <main className="max-w-2xl mx-auto px-4 pb-32 pt-6" dir="ltr">
      ...
      <div className="mb-5">
        ...
        <p className="font-english text-xs italic"
          ...
          Fī Riyāḍ Tafsīr al-Qurʾān al-Karīm · 56 lessons · Shaykh Ibrāhīm Niasse
        </p>
      </div>
      ...
      <div className="relative mb-5">
        ...
        {query && (
          <button onClick={() => setQuery('')}
            ...
            style={{color:'rgba(201,168,76,0.6)'}}>✕</button>
        )}
      </div>
            ...
            {showLessons && (
              <div className="p-3 space-y-1" style={{background:'var(--panel-body-bg, rgba(13,20,10,0.5))'}}>
                {LESSONS.map(l => (
                  <Link key={l.id} href={`/lesson/${l.id}`}
                    className="flex items-center justify-between px-3 py-2 rounded-lg border transition-all group"
                    style={{borderColor: l.hasText ? 'rgba(201,168,76,0.15)' : 'rgba(255,255,255,0.05)', background:'transparent'}}>
                    <div className="flex items-center gap-2 min-w-0">
                      <span className="font-english text-[10px] shrink-0" style={{color:'rgba(201,168,76,0.5)'}}>
                        {l.id}
                      </span>
