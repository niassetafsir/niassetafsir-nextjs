  ...
  return (
    <main className="max-w-4xl mx-auto px-4 pb-20 pt-6" dir="ltr">
      ...
      <h2 className="font-english text-gold text-xl font-semibold mt-10 mb-4 pb-3 border-b border-gold/20">This Edition: Structure, Method, and Translation Approach</h2>
        ...
        <p className="font-english text-white leading-relaxed mb-3 text-justify">Arabic transliteration follows IJMES conventions throughout. Following the name of the Prophet, the ligature ﷺ (ṣallā Allāhu ʿalayhi wa-sallam, “may Allāh’s peace and blessings be upon him”) stands in the English text for whatever form the Arabic gives; the Arabic itself is left exactly as the compiled edition prints it, whether spelled out or contracted, and is not emended to match. Following the names of Companions and recognized saints, r.a. (raḍiya Allāhu ʿanhu/ʿanhā, “may Allāh be pleased with him/her”) is retained in abbreviated form. ʿAlayhi al-salām, after the names of prophets other than Muḥammad, is left as the Arabic has it. Qurʾānic citations are given in the form Q. followed by chapter and verse numbers. Technical Arabic terms are given in transliteration on first occurrence with an English equivalent in parentheses; thereafter they appear in transliteration only. The Qurʾānic text in this edition follows the Warsh ʿan Nāfiʼ rasm.</p>
