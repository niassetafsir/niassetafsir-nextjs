  ...
  return (
    <main className="max-w-4xl mx-auto px-4 pb-20 pt-6" dir="ltr">
      ...
      <h2 className="font-english text-gold text-xl font-semibold mt-10 mb-4 pb-3 border-b border-gold/20">This Edition: Structure, Method, and Translation Approach</h2>
        ...
        <p className="font-english text-white leading-relaxed mb-3 text-justify">The digital edition of this work is accessible at niassetafsir.com, where the bilingual text and audio resources are made available as a free scholarly resource.</p>
