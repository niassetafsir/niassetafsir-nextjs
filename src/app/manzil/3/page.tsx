  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-12" dir="ltr">
      ...
      <a href="/lesson/24" className="flex items-center gap-4 px-5 py-4 hover:bg-gold/5 transition-colors group border-b border-white/5 last:border-0 no-underline">
        ...
        <div className="flex-1"><div className="font-english" style={{fontSize:"10px",color:"rgba(255,255,255,0.4)",textTransform:"uppercase",letterSpacing:"0.05em",marginBottom:"2px",direction:"ltr"}}>Lesson Twenty-Four</div><div dir="rtl">
        ...
        <div dir="ltr" className="hidden sm:block flex-1">
          <div className="font-english text-white/55 text-sm italic">Sūrat al-Aʿrāf / al-Anfāl · Q. 7:171–8:40-Four</div>
        </div>
      ...
      <a href="/lesson/25" className="flex items-center gap-4 px-5 py-4 hover:bg-gold/5 transition-colors group border-b border-white/5 last:border-0 no-underline">
        ...
        <div className="flex-1"><div className="font-english" style={{fontSize:"10px",color:"rgba(255,255,255,0.4)",textTransform:"uppercase",letterSpacing:"0.05em",marginBottom:"2px",direction:"ltr"}}>Lesson Twenty-Five</div><div dir="rtl">
        ...
        <div dir="ltr" className="hidden sm:block flex-1">
          <div className="font-english text-white/55 text-sm italic">Sūrat al-Aʿrāf / al-Anfāl · Q. 7:171–8:40-Five</div>
        </div>
        {false && <span className="font-english text-xs text-gold/55 border border-gold/20 px-2 py-0.5 rounded-full flex-shrink-0">EN ✓</span>}
      </a>
      <a href="/lesson/26" className="flex items-center gap-4 px-5 py-4 hover:bg-gold/5 transition-colors group border-b border-white/5 last:border-0 no-underline">
        ...
        <div className="flex-1"><div className="font-english" style={{fontSize:"10px",color:"rgba(255,255,255,0.4)",textTransform:"uppercase",letterSpacing:"0.05em",marginBottom:"2px",direction:"ltr"}}>Lesson Twenty-Six</div><div dir="rtl">
        ...
        <div dir="ltr" className="hidden sm:block flex-1">
          <div className="font-english text-white/55 text-sm italic">Sūrat al-Aʿrāf / al-Anfāl · Q. 7:171–8:40-Six</div>
        </div>
        {false && <span className="font-english text-xs text-gold/55 border border-gold/20 px-2 py-0.5 rounded-full flex-shrink-0">EN ✓</span>}
      </a>
      <a href="/lesson/27" className="flex items-center gap-4 px-5 py-4 hover:bg-gold/5 transition-colors group border-b border-white/5 last:border-0 no-underline">
        ...
        <div dir="ltr" className="hidden sm:block flex-1">
          <div className="font-english text-white/55 text-sm italic">Sūrat al-Aʿrāf / al-Anfāl · Q. 7:171–8:40-Seven</div>
        </div>
        {false && <span className="font-english text-xs text-gold/55 border border-gold/20 px-2 py-0.5 rounded-full flex-shrink-0">EN ✓</span>}
      </a>
      <a href="/lesson/28" className="flex items-center gap-4 px-5 py-4 hover:bg-gold/5 transition-colors group border-b border-white/5 last:border-0 no-underline">
        ...
        <div dir="ltr" className="hidden sm:block flex-1">
          <div className="font-english text-white/55 text-sm italic">Sūrat al-Aʿrāf / al-Anfāl · Q. 7:171–8:40-Eight</div>
        </div>
        {false && <span className="font-english text-xs text-gold/55 border border-gold/20 px-2 py-0.5 rounded-full flex-shrink-0">EN ✓</span>}
      </a>
      <a href="/lesson/29" className="flex items-center gap-4 px-5 py-4 hover:bg-gold/5 transition-colors group border-b border-white/5 last:border-0 no-underline">
        ...
        <div dir="ltr" className="hidden sm:block flex-1">
          <div className="font-english text-white/55 text-sm italic">Sūrat al-Aʿrāf / al-Anfāl · Q. 7:171–8:40-Nine</div>
        </div>
        {false && <span className="font-english text-xs text-gold/55 border border-gold/20 px-2 py-0.5 rounded-full flex-shrink-0">EN ✓</span>}
      </a>
