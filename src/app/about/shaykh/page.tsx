  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-16" dir="ltr">
      ...
      <h1 className="font-english text-white text-3xl font-semibold mt-6 mb-1">
        Shaykh Ibrāhīm Niasse and the Tafsīr Tradition
      </h1>
      <p className="font-english text-white/45 text-base mb-10">West African Islamic Intellectual History</p>
      ...
      <div className="font-english text-white/75 text-base leading-relaxed space-y-6">
        ...
        <p>As Samuel Ross has recently observed, tafsīr offers a powerful lens for reconstructing Islamic intellectual history precisely because of its encyclopedic character and its capacity to integrate every discipline of Muslim thought. The challenge, he notes, is particularly acute for "non-canonical topics not typically addressed in a manual of fiqh or a Sufi treatise," since "the history of Muslim attitudes toward countless topics can often be traced through the evolving interpretations of verses on a given theme."<sup>1</sup> Citing Jane McAuliffe&apos;s description of tafsīr as "a window looking into the Islamic Weltanschauung of any given generation," Ross concludes that because "the Qurʾān discusses myriad topics, and because of tafsīr&apos;s encyclopaedic nature, incorporating every Islamic discipline," it enables scholars to follow the conceptual shifts that occur across the tradition.<sup>2</sup></p>

        <p>This insight provides an essential methodological basis for the present study. By treating Shaykh Ibrāhīm Niasse&apos;s <em>Fī Riyāḍ al-Tafsīr</em> as a site where theological, philosophical, and metaphysical reflection intersect, this study builds on Ross&apos;s argument to demonstrate that West African tafsīr, no less than its classical, Mamlūk, and Ottoman counterparts, constitutes a primary archive for tracing the evolution of Islamic metaphysical imagination.</p>

        <p>The study examines <em>Fī Riyāḍ al-Tafsīr</em> through three interrelated axes: theology, metaphysical anthropology, and cosmology. Each corresponds to a fundamental question within Islamic intellectual history — the nature of the divine (God as such), the nature of the human (the human as such), and the relationship between the two. Rather than presupposing a systematic metaphysics, the study allows these categories to emerge inductively through close engagement with Niasse&apos;s exegesis, approaching <em>Riyāḍ al-Tafsīr</em> as a living archive of philosophical reflection in which the Qurʾān itself becomes the site through which metaphysical questions are posed, negotiated, and reimagined.</p>
        ...
        <p>This study intervenes in this lacuna by examining Shaykh Ibrāhīm Niasse&apos;s <em>Fī Riyāḍ al-Tafsīr</em> within the intellectual and manuscript culture of West Africa. Drawing on WAAMD, regional catalogues, and the transcribed texts of Niasse&apos;s recorded tafsīr majālis, it re-situates Qurʾānic commentary as a living, performative, and multilingual tradition. This approach expands tafsīr studies beyond the geography of print and beyond the assumption that hermeneutical innovation ceased after the so-called classical period. It demonstrates that West African exegetes did not merely inherit Middle Eastern models but re-articulated the Qurʾān&apos;s metaphysical and ethical horizons through local epistemologies of Sufi pedagogy, oral transmission, and bilingual expression.</p>
        ...
        <p>Modern Qurʾānic hermeneutics in the 19th and 20th centuries unfolded within what Georges Tamer identifies as the defining tension of the period: "the tension between preserving traditional methods and interpretations of the Qurʾān on the one hand and introducing new ones on the other." Two concerns were especially prominent: the need to demonstrate the compatibility of the Qurʾānic worldview with modern rationalism and the natural sciences, and the search for an appropriate political and social order that would meet the requirements of modernity without contradicting Qurʾānic principles.</p>
      ...
      <div className="mt-12 pt-6 border-t border-gold/20">
        ...
        <ol className="space-y-2 font-english text-white/40 text-xs leading-5 list-decimal list-inside">
