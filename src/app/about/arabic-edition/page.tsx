  ...
  return (
    <main className="max-w-2xl mx-auto px-6 py-16" dir="ltr">
      ...
      <div className="font-english text-white/70 text-base leading-relaxed space-y-5">
        ...
        <p>The ten-volume revised edition supersedes the earlier six-volume edition. The revision incorporates substantially expanded footnoting, verified hadith citations traced to their canonical sources, and a consolidated apparatus drawn directly from the original audio recordings. It represents the most complete and rigorously documented basis for the text.</p>
