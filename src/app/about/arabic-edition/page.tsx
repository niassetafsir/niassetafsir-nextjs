  ...
  return (
    <main className="max-w-2xl mx-auto px-6 py-16" dir="ltr">
      ...
      <div className="font-english text-white/70 text-base leading-relaxed space-y-5">
        ...
        <p>The ten-volume revised edition supersedes the earlier six-volume edition. It is more extensive, incorporating a larger number of footnotes and a more comprehensive critical apparatus. The revised edition also consulted a broader set of the original audio recordings to produce a more accurate transcription of Niasse&apos;s oral delivery.</p>
