  ...
  return (
    <main className="max-w-2xl mx-auto px-6 py-16" dir="ltr">
      ...
      <div className="font-english text-white/70 text-base leading-relaxed space-y-5">
        ...
        <p>The ten-volume revised edition supersedes the earlier six-volume edition. Both editions verify citations; the revision extends this verification across a wider range of sources — beyond hadith to tafsīr works, Sufi literature, and linguistic references — and incorporates a more extensive critical apparatus throughout. The revised edition also consulted a broader set of original audio recordings to produce a more accurate transcription of Niasse&apos;s oral delivery. It represents the most complete and rigorously documented basis for the text.</p>
