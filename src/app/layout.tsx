        ...
        <footer className="border-t border-white/10 py-8 px-6">
          <div className="flex items-center justify-between max-w-5xl mx-auto">
            ...
            <a href="mailto:niassetafsirproject@gmail.com"
              className="font-english text-xs text-white/35 hover:text-gold/70 transition-all">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://www.instagram.com/niassetafsirproject" target="_blank" rel="noopener"
                className="text-white/35 hover:text-gold/80 transition-all" title="Instagram">
              ...
              <a href="https://x.com/niassetafsir" target="_blank" rel="noopener"
                className="text-white/35 hover:text-gold/80 transition-all" title="X">
              ...
              <a href="https://www.facebook.com/niassetafsirproject" target="_blank" rel="noopener"
                className="text-white/35 hover:text-gold/80 transition-all" title="Facebook">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
