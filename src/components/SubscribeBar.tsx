      ...
      {status === 'success' ? (
        ...
        <form onSubmit={handleSubmit} className="flex gap-2 max-w-sm mx-auto">
          <input
            ...
            required
            className="flex-1 bg-white/8 border border-gold/25 rounded-lg px-3 py-2 font-english text-white placeholder-white/30 text-sm focus:outline-none focus:border-gold/50"
          />
          <button
            type="submit"
