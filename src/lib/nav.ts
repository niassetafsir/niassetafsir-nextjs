...
export const NAV: NavSection[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/glossary', label: 'Terms', hint: 'In context across the corpus' },
  ...
  },
  {
    ...
    children: [
      { href: '/about', label: 'This edition', hint: 'The project and the text behind it' },
      { href: '/about/shaykh', label: 'Shaykh Ibrāhīm', hint: 'And the sessions' },
      { href: '/about/arabic-edition', label: 'The Arabic edition', hint: 'The ten-volume Tunis printing' },
      { href: '/about/companion-texts', label: 'Companion texts', hint: 'Jalālayn, Rūḥ al-Bayān' },
